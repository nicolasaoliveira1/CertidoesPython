...
2. O sistema abre uma janela do Chrome (maximizada) usando o perfil dedicado configurado e navegação em modo anônimo, preenchendo os dados automaticamente
